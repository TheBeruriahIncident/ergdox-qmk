...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [COLEMAK_DHM] = LAYOUT_ergodox_pretty(
    ...
    CAPS_WORD,      KC_A,           KC_R,           KC_S,           KC_T,           KC_G,                                                                           KC_M,           KC_N,           KC_E,           KC_I,           KC_O,           KC_SCOLON,
  ...
  [SYMBOLS] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_EQUAL,       KC_SCOLON,      KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,                                                                                              KC_TRANSPARENT, KC_DOT,         KC_0,           KC_EQUAL,       KC_KP_ENTER,
                                                                                                    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
                                                                                                                    KC_TRNS,        KC_TRNS,
